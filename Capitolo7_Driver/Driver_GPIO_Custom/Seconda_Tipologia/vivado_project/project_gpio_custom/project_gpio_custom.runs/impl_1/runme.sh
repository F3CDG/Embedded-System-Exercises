...
HD_PWD='/home/daniele/Sistemi_Embedded/Esercitazione_7/Driver/Esercitazione_7/Driver_GPIO_Custom/Prima_Tipologia/vivado_project/project_gpio_custom/project_gpio_custom.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_for_gpio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_for_gpio_wrapper.tcl -notrace

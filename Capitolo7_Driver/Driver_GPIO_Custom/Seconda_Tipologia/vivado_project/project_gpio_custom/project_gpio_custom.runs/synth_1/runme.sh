...
HD_PWD='/home/daniele/Sistemi_Embedded/Esercitazione_7/Driver/Esercitazione_7/Driver_GPIO_Custom/Prima_Tipologia/vivado_project/project_gpio_custom/project_gpio_custom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_for_gpio_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_for_gpio_wrapper.tcl

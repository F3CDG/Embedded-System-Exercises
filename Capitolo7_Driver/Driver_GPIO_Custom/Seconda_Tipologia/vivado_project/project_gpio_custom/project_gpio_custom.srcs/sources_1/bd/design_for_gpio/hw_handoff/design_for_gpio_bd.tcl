...
proc create_root_design { parentCell } {
  ...
  # Create instance: my_gpio_1, and set properties
  set my_gpio_1 [ create_bd_cell -type ip -vlnv user.org:user:my_gpio:1.0 my_gpio_1 ]

  # Create instance: my_gpio_2, and set properties
  set my_gpio_2 [ create_bd_cell -type ip -vlnv user.org:user:my_gpio:1.0 my_gpio_2 ]
...
CONFIG.NUM_MI {3} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins my_gpio_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins my_gpio_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins my_gpio_2/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports s] [get_bd_pins my_gpio_1/pad]
  connect_bd_net -net Net1 [get_bd_ports b] [get_bd_pins my_gpio_0/pad]
  connect_bd_net -net Net2 [get_bd_ports l] [get_bd_pins my_gpio_2/pad]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins my_gpio_0/s00_axi_aclk] [get_bd_pins my_gpio_1/s00_axi_aclk] [get_bd_pins my_gpio_2/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins my_gpio_0/s00_axi_aresetn] [get_bd_pins my_gpio_1/s00_axi_aresetn] [get_bd_pins my_gpio_2/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_gpio_0/S00_AXI/S00_AXI_reg] SEG_my_gpio_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_gpio_1/S00_AXI/S00_AXI_reg] SEG_my_gpio_1_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_gpio_2/S00_AXI/S00_AXI_reg] SEG_my_gpio_2_S00_AXI_reg
...
preplace portBus l -pg 1 -y 330 -defaultsOSRD
preplace portBus b -pg 1 -y 70 -defaultsOSRD
preplace portBus s -pg 1 -y 190 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 170 -defaultsOSRD
preplace inst my_gpio_0 -pg 1 -lvl 3 -y 70 -defaultsOSRD
preplace inst my_gpio_1 -pg 1 -lvl 3 -y 190 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 180 -defaultsOSRD
preplace inst my_gpio_2 -pg 1 -lvl 3 -y 330 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 420 -defaultsOSRD
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 760
preplace netloc processing_system7_0_DDR 1 1 3 450J 410 NJ 410 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 440
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 460 10 770
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 20 90 430
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 N
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 350 760J 400 1000J
preplace netloc Net1 1 3 1 NJ
preplace netloc Net 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 30 280 470 490 780
...
levelinfo -pg 1 0 230 620 890 1020 -top 0 -bot 560
",
}

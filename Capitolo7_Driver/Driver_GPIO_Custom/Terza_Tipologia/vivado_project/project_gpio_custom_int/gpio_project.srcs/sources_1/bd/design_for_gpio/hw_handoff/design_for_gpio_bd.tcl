...
################################################################
# This is a generated script based on design: design_for_gpio
#
...
# source design_for_gpio_script.tcl
...
set design_name design_for_gpio
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set b [ create_bd_port -dir IO -from 3 -to 0 b ]
  set l [ create_bd_port -dir IO -from 3 -to 0 l ]
  set s [ create_bd_port -dir IO -from 3 -to 0 s ]

  # Create instance: my_gpio_int_0, and set properties
  set my_gpio_int_0 [ create_bd_cell -type ip -vlnv user.org:user:my_gpio_int:1.0 my_gpio_int_0 ]

  # Create instance: my_gpio_int_1, and set properties
  set my_gpio_int_1 [ create_bd_cell -type ip -vlnv user.org:user:my_gpio_int:1.0 my_gpio_int_1 ]

  # Create instance: my_gpio_int_2, and set properties
  set my_gpio_int_2 [ create_bd_cell -type ip -vlnv user.org:user:my_gpio_int:1.0 my_gpio_int_2 ]
...
CONFIG.NUM_PORTS {3} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins my_gpio_int_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins my_gpio_int_1/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins my_gpio_int_2/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports l] [get_bd_pins my_gpio_int_2/pad]
  connect_bd_net -net Net1 [get_bd_ports s] [get_bd_pins my_gpio_int_1/pad]
  connect_bd_net -net Net2 [get_bd_ports b] [get_bd_pins my_gpio_int_0/pad]
  connect_bd_net -net my_gpio_int_0_irq [get_bd_pins my_gpio_int_0/irq] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net my_gpio_int_1_irq [get_bd_pins my_gpio_int_1/irq] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net my_gpio_int_2_irq [get_bd_pins my_gpio_int_2/irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins my_gpio_int_0/s00_axi_aclk] [get_bd_pins my_gpio_int_1/s00_axi_aclk] [get_bd_pins my_gpio_int_2/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins my_gpio_int_0/s00_axi_aresetn] [get_bd_pins my_gpio_int_1/s00_axi_aresetn] [get_bd_pins my_gpio_int_2/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_gpio_int_0/S00_AXI/S00_AXI_reg] SEG_my_gpio_int_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_gpio_int_1/S00_AXI/S00_AXI_reg] SEG_my_gpio_int_1_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_gpio_int_2/S00_AXI/S00_AXI_reg] SEG_my_gpio_int_2_S00_AXI_reg
...
preplace portBus l -pg 1 -y 440 -defaultsOSRD
preplace portBus b -pg 1 -y 120 -defaultsOSRD
preplace portBus s -pg 1 -y 260 -defaultsOSRD
preplace inst my_gpio_int_0 -pg 1 -lvl 4 -y 130 -defaultsOSRD
preplace inst my_gpio_int_1 -pg 1 -lvl 4 -y 270 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 2 -y 180 -defaultsOSRD
preplace inst my_gpio_int_2 -pg 1 -lvl 4 -y 450 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 1 -y 380 -defaultsOSRD
...
preplace netloc processing_system7_0_DDR 1 2 3 NJ 360 NJ 360 NJ
...
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 240 270 640
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 3 1 990
preplace netloc my_gpio_int_0_irq 1 0 5 20 280 NJ 280 670J 350 NJ 350 1250
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 2 2 700 470 1020
preplace netloc my_gpio_int_2_irq 1 0 5 40 310 NJ 310 NJ 310 980J 370 1240
preplace netloc xlconcat_0_dout 1 1 1 220
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ 380 NJ 380 NJ
preplace netloc my_gpio_int_1_irq 1 0 5 30 300 NJ 300 660J 340 NJ 340 1240
...
preplace netloc processing_system7_0_FCLK_CLK0 1 1 3 230 90 680 520 1000
preplace netloc Net2 1 4 1 NJ
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 3 1 1010
levelinfo -pg 1 0 130 440 840 1130 1270 -top 0 -bot 590
",
}

...
HD_PWD='/home/daniele/Sistemi_Embedded/Esercitazione_7/Driver/Esercitazione_7/Driver_GPIO_Custom/Terza_Tipologia/vivado_project/project_gpio_custom_int/gpio_project.runs/impl_1'
cd "$HD_PWD"

...
HD_PWD='/home/daniele/Sistemi_Embedded/Esercitazione_7/Driver/Esercitazione_7/Driver_GPIO_Xilinx/Prima tipologia/vivado_project/project_gpio/project_gpio.runs/design_for_gpio_auto_pc_0_synth_1'
cd "$HD_PWD"

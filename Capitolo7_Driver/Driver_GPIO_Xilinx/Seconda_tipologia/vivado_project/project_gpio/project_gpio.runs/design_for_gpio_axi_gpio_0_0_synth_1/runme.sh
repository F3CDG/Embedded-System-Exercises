...
HD_PWD='/home/daniele/Sistemi_Embedded/Esercitazione_7/Driver/Esercitazione_7/Driver_GPIO_Xilinx/Seconda_tipologia/vivado_project/project_gpio/project_gpio.runs/design_for_gpio_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_for_gpio_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_for_gpio_axi_gpio_0_0.tcl

...
HD_PWD='/home/daniele/Sistemi_Embedded/Esercitazione_7/Driver/Esercitazione_7/Driver_GPIO_Xilinx/Seconda_tipologia/vivado_project/project_gpio/project_gpio.runs/synth_1'
cd "$HD_PWD"

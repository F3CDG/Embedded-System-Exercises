...
EAStep vivado -log design_gpio_interrupt_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_gpio_interrupt_wrapper.tcl

...
HD_PWD='/home/daniele/Scrivania/workspace_master/zybo_base_system/source/hw/project_gpio_interrupt/project_gpio_interrupt.runs/design_gpio_interrupt_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_gpio_interrupt_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_gpio_interrupt_axi_gpio_0_2.tcl

...
HD_PWD='/home/ciro/Scrivania/SE/Elaborati/Elaborato1/gpio_project/gpio_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_for_gpio_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source design_for_gpio_wrapper.tcl

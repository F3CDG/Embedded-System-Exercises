...
HD_PWD='/home/ciro/Scrivania/SE/Elaborati/Elaborato1/gpio_project/gpio_project.tmp/my_gpio_v1_0_project/my_gpio_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_gpio_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source my_gpio_v1_0.tcl
